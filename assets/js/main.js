(function($) {
	...
	// Header behavior for scroll
	if ($banner.length > 0 && $header.hasClass('banner-header')) {
...
$(document).ready(function () {
	var $chartsLink = $('nav ul li:contains("CHARTS") > a'); // Adjust if needed
	var $chartsDropdown = $('nav ul li:contains("CHARTS") ul');
